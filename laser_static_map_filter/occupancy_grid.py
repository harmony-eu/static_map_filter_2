...
"""
Add license statement once one becomes available
"""
...
class OccupancyGridManager:
    ...
    def _occ_grid_cb(self, data):
        # self.get_logger().log(severity='INFO', message="Got a full OccupancyGrid update")
    ...
    def _occ_grid_update_cb(self, data):
        # self.get_logger().log(severity='INFO', message="Got a partial OccupancyGrid update")
